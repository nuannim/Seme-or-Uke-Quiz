  ...
  try {
    ...
    qna = [
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "อะไรก็ได้", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ร้านนี้ก็ดีนะ", "seme": 1, "uke": 2 },
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "นั่งเฉย ๆ ไม่มีไร", "seme": 0, "uke": 3 },
          { "id": "B", "text": "เอียงหัวไปพิงกลับเบา ๆ", "seme": 1, "uke": 2 },
          { "id": "C", "text": "แซวขำ ๆ ว่าคิดค่าเช่าไหล่นะ", "seme": 2, "uke": 1 },
          { "id": "D", "text": "ถาม 'ว่าไงจ๊ะ มีอะไรรึ'", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 4,
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "แอบเลือกมุมที่ตัวเองดูดีที่สุด", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ยืนตรงไหนก็ได้ แต่ขอดูรูปก่อนลง", "seme": 1, "uke": 2 },
          { "id": "C", "text": "ยืนตรงไหนก็ได้ ถ่ายเสร็จก็จบ", "seme": 2, "uke": 1 },
          { "id": "D", "text": "จัดทุกคนเข้าที่แล้วเป็นคนถ่ายให้เอง", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 7,
        ...
        "choices": [
          { "id": "A", "text": "พิมพ์ตอบขอบคุณสั้น ๆ 'ขอบคุณน้าา' พร้อมส่งสติกเกอร์น่ารัก ๆ กลับไป", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ตอบรับและบ่นเป็นห่วงเขานิดหน่อย 'อื้อ เธอก็ด้วยนะ อย่าทำงานดึกนักล่ะ'", "seme": 1, "uke": 2 },
          { "id": "C", "text": "ตอบกลับแบบมั่นใจ 'ได้เลยย ไม่ต้องห่วง สบายมาก!'", "seme": 2, "uke": 1 },
          { "id": "D", "text": "ตอบสไตล์ดูแลและเตือนกลับ 'ขอบคุณนะ เดี๋ยวจะดูแลตัวเองอย่างดี เธอเองก็อย่าดื้อล่ะ'", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 8,
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "ตอบ 'เค้าก็หิวเหมือนกัน ทำอะไรให้กินหน่อยสิ'", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ตอบ 'ไปหาอะไรกินกันนน' ทั้งที่ตัวเองไม่หิว", "seme": 1, "uke": 2 },
          { "id": "C", "text": "ส่งรูปของกินไปกวนให้หิวกว่าเดิมแล้วชวนไปหาอะไรกิน", "seme": 2, "uke": 1 },
          { "id": "D", "text": "ถามด้วยความใส่ใจ 'อยากกินอะไรเป็นพิเศษไหม? เดี๋ยวเค้าพาไปกินนะ'", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 10,
      ...
      },
      {
        ...
        "choices": [
          ...
          { "id": "C", "text": "เงยหน้าขึ้นมา 'พื้นตรงนี้มันอยากกอดเราน่ะ'", "seme": 2, "uke": 1 },
          { "id": "D", "text": "รีบเด้งตัวลุกขึ้นยืน 'ไม่มีอะไรเกิดขึ้นทั้งนั้นล่ะ!'", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 12,
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "บ่นพึมพำแก้เขิน 'อ้วนที่ไหนล่ะ! เสื้อผ้ามันหดต่างหาก!'", "seme": 0, "uke": 3 },
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "ยืนสังเกตการณ์เงียบ ๆ คอยดูว่าคนของเราจะจัดการกับสถานการณ์ยังไง", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ขยับเข้าไปยืนใกล้ ๆ เพื่อแสดงตัวว่าเรามาด้วยกัน", "seme": 1, "uke": 2 },
          { "id": "C", "text": "เดินเข้าไปร่วมวงสนทนาด้วยรอยยิ้ม แล้วแกล้งทักคนของเราเพื่อเปลี่ยนประเด็น", "seme": 2, "uke": 1 },
          { "id": "D", "text": "เข้าไปจับไหลอีกฝ่าย แล้วบอกอีกฝ่ายสุภาพว่า 'ขอตัวก่อนนะ พอดีพวกเรามีนัดน่ะ'", "seme": 3, "uke": 0 }
        ]
      },
      {
        "id": 15,
      ...
      },
      {
        ...
        "choices": [
          ...
          { "id": "B", "text": "ใจเต้นรัว แอบมองเป็นระยะ ๆ แต่ไม่กล้าทัก", "seme": 1, "uke": 2 },
      ...
      },
      {
        ...
        "choices": [
          { "id": "A", "text": "บ้านผีสิง... ขอเดินเกาะแขนเพื่อนคนอื่นแน่น ๆ ตลอดทางเลยนะ", "seme": 0, "uke": 3 },
          { "id": "B", "text": "ม้าหมุนตริ้ว ๆ กินสายไหมสบายใจ", "seme": 1, "uke": 2 },
          { "id": "C", "text": "ล่องแก่งพอแล้ว ให้ตื่นเต้นเสียวท้องน้อยขำ ๆ", "seme": 2, "uke": 1 },
